...
server.tool(
    "add-client-credentials-to-project",
    {
        email: z.string(),
        password: z.string(),
...
server.tool(
    "list-connectors-for-creating-workflows",
    {
        email: z.string(),
        password: z.string()
    },
...
server.tool(
    "list-integration-flows-for-project",
    {
        email: z.string(),
        password: z.string(),
